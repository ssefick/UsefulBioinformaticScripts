...
parser$add_argument("-t", "--tabix_index", action="store", default="tabix index", dest="input_tabix", help="Input %(default)s")

parser$add_argument("-o", "--output_vcf", action="store", default="Filtered Vcf", dest="output_vcf", help="Output %(default)s")

parser$add_argument("-RGQ", "--Reference_Genotype_Quality", action="store", default=30, dest="RGQ_value", help="Default: %(default)s")

parser$add_argument("-minDP", "--min_Depth", action="store", default=5, dest="minDP", help="Default: %(default)s")

parser$add_argument("-maxDP", "--max_Depth", action="store", default=120, dest="maxDP", help="Default: %(default)s")

parser$add_argument("-GQ", "--Genotype_Quanlity", action="store", default=20, dest="GQ", help="Default: %(default)s")

parser$add_argument("-C", "--CHUNKS", action="store", default=10, dest="CHUNKS",
